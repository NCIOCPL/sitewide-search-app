Feature: As a content editor, I would like to identify content for users to find that are related to their search term, in order to aid them in their search for cancer information.
    ...
    Scenario: Single best bet with sinlge link
        ...
        And the system displays best bet number 1 title "Resultados recomendados para Medicamentos para el cáncer" as an "h2" tag
        ...
        And the system displays best bet number 2 title "Resultados recomendados para ¿Qué es el cáncer?" as an "h2" tag
