Feature: As a user, I would like to be able to page through search results from both the top and bottom of the page so that I can browse my search results.
  ...
  Scenario: Spanish Search Results Pager
    ...
    And user clicks "Siguiente" and displays 1, 2, and 3 followed by "...", and 2 highlighted as the page they are on and "Ir a la Página" for screen readers and 560 and "Siguiente >"
    And the last page number to be visible
    And the option for "< Anterior" appears before the page numbers
    And user clicks "Siguiente" and displays 1, 2, 3, and 4 followed by "...", and 3 highlighted as the page they are on and "Ir a la Página" for screen readers
    And the last page number to be visible
    And the option for "< Anterior" appears before the page numbers
    And user clicks "Siguiente" and displays 1, 2, 3, 4, and 5 followed by "...", and 4 highlighted as the page they are on and "Ir a la Página" for screen readers
    And the last page number to be visible
    And the option for "< Anterior" appears before the page numbers
    And user clicks "Siguiente" and displays 1 followed by "...", 4, 5, 6 followed by "...", and 5 highlighted as the page they are on and 560 the last page and "Ir a la Página" for screen readers
    And the last page number to be visible
    And the option for "< Anterior" appears before the page numbers