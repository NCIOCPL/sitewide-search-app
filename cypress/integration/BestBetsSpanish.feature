Feature: As a content editor, I would like to identify content for users to find that are related to their search term, in order to aid them in their search for cancer information.
    ...
    Scenario: Single best bet with sinlge link
        ...
        And the title of the related item number 4 appears as a link with text "Formulación y aprobación de medicamentos"
        And the description of the item number 4 appears below the title
        And the title of the related item number 5 appears as a link with text "Medicamentos aprobados para diferentes tipos de cáncer"
        And the description of the item number 5 appears below the title
        And the title of the related item number 6 appears as a link with text "Medicamentos aprobados para enfermedades relacionadas con el cáncer"
        And the description of the item number 6 appears below the title
